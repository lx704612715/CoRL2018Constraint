...
import prismatic_constraint.prismatic_constraint as psc
import axial_rotation_constraint.axial_rotation_constraint as arc
import numpy as np

pccProc = ConstraintProcessing(pcc, include_velocities=False)
pscProc = ConstraintProcessing(psc, include_velocities=False)
arcProc = ConstraintProcessing(arc, include_velocities=False)
